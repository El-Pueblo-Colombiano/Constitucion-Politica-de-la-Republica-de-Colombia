---
title: "Capítulo 3 - Del Vicepresidente"
...
```txt
Para ser elegido Vicepresidente se requieren las mismas calidades que
...
período siguiente cuando el Presidente en ejercicio no se presente
como candidato.
```
</Accordion>
...
```txt
Para ser elegido Vicepresidente se requieren las mismas cualidades que
para ser Presidente de la República.
