---
title: "Artículo 177"
description: "Artículo 177 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
cumpliendo con las condiciones establecidas en este artículo:
...
Al menos un 70% del área de primer piso de la(s)
...
Al menos un 60% del área de primer piso de la(s)
  edificación(es) deberá ser destinada a servicios sociales y del cuidado y
...
Parágrafo 1. Cuando se supere la proporción de mezcla a la que
se hace referencia este artículo, se aplicarán las condiciones de
edificabilidad y cargas urbanísticas definidas para otros usos del suelo.

Parágrafo 2. Para la aplicación de la mezcla de usos de que
trata el presente artículo, los usos diferentes al dotacional permitidos son
los establecidos para cada una de las áreas de actividad.

Parágrafo 3. Los servicios sociales son compatibles entre
...
presten varios servicios sociales no se considera mezcla de usos.

Parágrafo 4. En las cesiones públicas destinadas a
...
un instrumento de planeamiento o de gestión.

Parágrafo 5. Las condiciones de mezcla de uso de los
