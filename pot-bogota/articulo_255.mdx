---
title: "Artículo 255"
description: "Artículo 255 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
través de las normas de uso y aprovechamiento del suelo.
...
contexto específico, en términos de calidad físico-espacial y funcional.

Este objetivo se concreta mediante decisiones normativas contenidas en el
tratamiento urbanístico de desarrollo y en la modalidad de revitalización
cuando se opte por el desarrollo de plan parcial.

2. Revitalización de la ciudad consolidada. Mediante la definición de los parámetros y
...
CONDICIONES GENERALES APLICABLES A TODOS
