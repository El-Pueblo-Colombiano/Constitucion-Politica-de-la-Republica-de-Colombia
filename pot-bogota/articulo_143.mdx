...
<Accordion title="Parágrafo" defaultOpen>
  El Departamento Administrativo Distrital de la Defensoría del Espacio Público deberá solicitar ante la Secretaría Distrital de Planeación la modificación del plano urbanístico correspondiente, la cual se hará con base en la licencia señalada en el numeral anterior.
</Accordion>