---
title: "Artículo 444"
description: "Artículo 444 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
1.La localización de Estaciones
...
2.Para la localización de Estaciones Radioeléctricas en suelo rural del
...
3.Cuando se plantee la localización e instalación de Estaciones
...
4.La localización e instalación de Estaciones Radioeléctricas en el espacio
público, solo se permitirán en áreas que no afecten las franjas de circulación
del Espacio Público para la Movilidad Rural.

5.Cuando se trate de la localización e instalación de estaciones
...
6.En todos los casos, los encargados de la implantación de las
...
asociados a la seguridad o mobiliario inteligente.

7.Los procesos de mimetización y camuflaje de las estaciones de
