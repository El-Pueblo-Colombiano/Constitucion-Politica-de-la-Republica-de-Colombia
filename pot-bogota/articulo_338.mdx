---
title: "Artículo 338"
description: "Artículo 338 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
urbanístico de mejoramiento son las siguientes:

ALTURA MÁXIMA PERMITIDA / OBLIGACIONES
  URBANÍSTICAS
...
La condición de englobe o integración predial debe cumplirse para la
...
Obligación urbanística de cesión en suelo para
  espacio público


25% del área del terreno para predios igual o mayor a 2000 m2 y hasta
...
Obligación urbanística para la construcción de
  redes locales y de infraestructura.


Para predios igual o mayor a 2.000 m2 se aplica la fórmula establecida en
...
Para predios igual o mayor a 2000 m2 se exige el 20% del área vendible
  del proyecto para Vivienda de Interés Prioritario – VIP.
...
Nota 1. Las obras nuevas se someten a las disposiciones de este artículo y a las
contenidas en el “Manual de normas Comunes a los Tratamientos Urbanísticos”.

Nota 2. Cuando se deba cumplir con la obligación urbanística de cesión en suelo
...
Nota 3. Las alturas de las edificaciones en el área de influencia de los Cables
...
la posibilidad de superar esa altura.

Nota 4. En todos los puntos de corte sobre el terreno y sobre cada una de las
fachadas, no se podrá superar la altura máxima permitida. En ningún caso se
permiten construcciones en terrenos con pendiente superior a 45 grados (100%).

Nota 5. En todos los casos, los predios en terreno inclinado con pendiente superior
a 12% y aquellos que se localicen en bordes urbanos no podrán superar la altura
de tres (3) pisos

Nota 6. Cuando se vincule como mínimo el 70% de los moradores al proyecto, no se
