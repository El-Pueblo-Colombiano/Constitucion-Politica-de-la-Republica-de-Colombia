---
title: "Artículo 277"
description: "Artículo 277 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
1. En suelo de expansión urbana. En todos los casos mediante la
...
2.1. Mediante el respectivo plan parcial, cumpliendo con las disposiciones
establecidas en el Decreto Único Reglamentario 1077 de 2015 o la norma que lo
adicione o sustituya:

2.1.1. Cuando hagan parte de las áreas predelimitadas a las que se refiere
el Mapa “Planes parciales Pre delimitados”, que requieran de gestión
asociada y tengan más de diez (10) hectáreas.

2.1.2. Cuando se trate de predios objeto de recuperación morfológica.

2.2. Mediante la aprobación de un proyecto urbanístico general o licencia
...
2.2.1. Se trate de predio(s) localizado(s) en zonas cuya área no supere las
...
2.2.2. Se trate de un solo predio cuya área supere las diez (10) hectáreas
...
Parágrafo 1. En todos los casos, se requerirá plan parcial
...
procesos de concertación ambiental.

Parágrafo 2. De conformidad con lo establecido en el Decreto
...
Parágrafo 3. En el marco de los instrumentos de planeación se
podrán identificar las áreas que por sus características deban adelantar la
formulación de Planes Parciales.

Parágrafo 4. Los predios que se localizan al interior de Planes
