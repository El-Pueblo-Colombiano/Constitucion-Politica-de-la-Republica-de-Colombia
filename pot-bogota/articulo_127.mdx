...
1. Cada uno de los globos deberá garantizar su funcionamiento como unidad autónoma y auto sostenible.
2. La ejecución de los componentes funcionales de cada globo será completa, no se podrá dividir un mismo componente funcional en diferentes globos de ejecución.
3. La división de cada uno de los globos deberá armonizarse con la ejecución del desarrollo vial y de la infraestructura de servicios públicos, para garantizar su auto sostenibilidad.
