---
title: "Artículo 270"
description: "Artículo 270 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
los porcentajes obligatorios para cesión de espacio público.

Para tal fin, en el marco de las Unidades de Planeamiento Local se
definirán los valores de referencia de obra pública determinados en conjunto
con las entidades competentes para administrar el espacio público.

Parágrafo 1. Hasta que se adelante el proceso de formulación
