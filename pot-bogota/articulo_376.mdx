---
title: "Artículo 376"
description: "Artículo 376 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
desarrollador del proyecto deberá:

1.Movilización. Corresponde al reconocimiento al pago en dos
oportunidades de los gastos de mudanza.
...
pague en la misma zona, con características similares.

3.Reconocimiento del lucro cesante, para actividades productivas, por
el periodo comprendido entre la entrega del inmueble a la entidad encargada de
la gestión del proyecto y la entrega del inmueble de reemplazo.
