---
title: "Artículo 17"
description: "Artículo 17 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
1. Medidas de mitigación. Las medidas de mitigación buscan reducir los
...
modifique o sustituya, así como a las siguientes medidas:
...
Relación con medidas de
  mitigación del PAC




1. Manejo y Conservación de Ecosistemas
...
 2. Desarrollo rural bajo en carbono
...
Busca que en las edificaciones se incluyan
  ...
  normas e instrumentos disponibles los requerimientos a cumplir.


Mejoras energéticas en edificaciones existentes
...
 5. Infraestructura para la gestión
...
Medidas enmarcadas en la gestión integral de los
  ...
  Innovación Doña Juana en coordinación con el PGIRS.


Formular e implementar un nuevo modelo de
...
6. Eficiencia energética e infraestructura para
...
Busca implementar Fuentes No Convencionales de
  ...
  jurídico y regulatorio aplicable a la materia.


Soluciones energéticas alternativas basadas en
  Fuentes No Convencionales de Energía Renovable en los proyectos de
  infraestructura y vivienda.
 
Cambio de combustibles, eficiencia energética en
  el sector industrial y desarrollo de distritos térmicos.
...
2. Medidas de adaptación. Las medidas de adaptación se orientan a ajustar
...
instrumento que lo modifique o sustituya y a las siguientes medidas:
...
1. Proteger las zonas naturales de amortiguación
...
A través de la conservación de áreas naturales y
  ...
  inundaciones y movimientos en masa, entre otros.


Implementar programas y proyectos de adaptación
...
A través de la disminución de la vulnerabilidad
  ...
  aumento de la temperatura como la alta montaña con énfasis en los páramos.


Formulación e implementación de un programa de
...
Incorporación de lineamientos y determinantes
...
4. Gestión integral del recurso
  hídrico
...
Se plantean estrategias territoriales de
  ...
  sustituya y los POMCA adoptados.


Gestión del recurso hídrico para la adaptación y
...
Fortalecimiento y consolidación de los Sistemas
  ...
  ante eventos de precipitaciones extremas.




5.Reverdecimiento urbano


Se incrementará el área verde, las coberturas
...
Acciones de prevención que se adoptan con
  ...
  infraestructura y los recursos ambientales.


Implementación de un programa de gestión del
