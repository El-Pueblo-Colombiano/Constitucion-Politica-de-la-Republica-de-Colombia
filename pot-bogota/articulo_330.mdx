---
title: "Artículo 330"
description: "Artículo 330 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
declaratorias de los bienes de interés cultural.

Para este fin se deberá cumplir con las siguientes condiciones:

1.Por cada m2 de construcción requerido se podrá adquirir un (1) metro
...
Cultural para la aplicación del instrumento.

2.La edificabilidad adquirida por derechos de construcción y desarrollo en
...
3.Para el pago compensatorio en dinero (PD) del proyecto que resulte de la
...
deberá utilizar el valor catastral (Vct) de la zona generadora.

Parágrafo 1. En el momento de la solicitud de la licencia
...
BIC beneficiarios de este instrumento.

Parágrafo 2. El pago de los certificados de construcción se
deberá realizar al fondo cuenta o mecanismo que se defina para tal fin, que
será administrado por el IDPC o la entidad que se establezca.

Parágrafo 3. Deberá quedar señalado en el folio de matrícula
inmobiliaria del BIC beneficiario la utilización de este instrumento.

Parágrafo 4. El IDPC o la entidad competente reglamentará
