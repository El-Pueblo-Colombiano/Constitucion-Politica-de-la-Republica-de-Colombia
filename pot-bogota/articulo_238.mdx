---
title: "Artículo 238"
description: "Artículo 238 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
No es generador de vertimientos con sustancias
...
Es generador de vertimientos con sustancias de
...
NOTA: En caso de presentar más de una sustancia
  de interés sanitario el valor corresponderá al puntaje más alto.
...
Es Micro generador de residuos peligrosos (Menor
...
Es Mediano generador (entre 100 y menor a 1.000
...
Es Gran generador (igual o mayor a 1.000
...
TRABAJO ÚNICAMENTE EN HORARIO DIURNO Y GENERA
  ...
  del 2006 y el Decreto 1076 del 2015 o la norma que lo modifique o sustituya. 
...
Se encuentra dentro de los niveles Estándares
...
Genera emisiones que no requieren estudio ni
...
Genera emisiones que requieren estudio y/o se
...
Genera emisiones que requieren de estudio y
  permiso de emisiones. Según Reglamentación Min Ambiente Decreto 948 de 1995 y
  Resolución 619 de 1997, o la norma que lo modifique o sustituya.
...
Genera olores susceptibles de mitigar con
  ...
  Resolución Min Ambiente 1541 de 2013, o la norma que la modifique o sustituya
...
Emiten sustancias generadoras de olores
...
Contar con certificación ambiental ISO 14001
...
No almacena, importa, utiliza, obtiene en
  ...
  columna 2 del anexo mencionado.
...
Almacenan, importan, utilizan, obtienen en
...
Almacenan, importan, utilizan, obtiene en
  procesos intermedios, venden o ceden a título gratuito al menos una de las
  sustancias peligrosas presentes en el Anexo 1 de la Directiva Seveso III, en
  cantidad igual o mayor al valor umbral (columna 3) del anexo mencionado y/o
  almacena dichas sustancias peligrosas (insumos) en tanques subterráneos.
...
NOTA: Para el cálculo de este aspecto es
...
No usa calderas o usa calderas con potencia
...
c. Caldera que sea utilizada únicamente como
  calentador de agua y cuya presión de trabajo no sea superior a 50 kPa
...
Usa calderas con potencia menor o igual a 1000
  kW
...
Usa calderas con potencia mayor de 1000 kW, y/o
  Almacena combustibles derivados de hidrocarburos para el funcionamiento de
  las calderas de manera subterránea.
...
NOTA: Si en el establecimiento se tienen varios
  dispositivos a presión se tendrá en cuenta el de mayor potencia.
...
No usa, o usa un vehículo automotor rígido de
  máximo dos (2) ejes, para el desarrollo de su actividad.
...
Usa vehículo automotor rígido de tres (3) o
  cuatro (4) ejes, para el desarrollo de su actividad.
...
Usa vehículo automotor con semi-remolque,
  remolque o remolque balanceado, para el desarrollo de su actividad.
...
Sus actividades se desarrollan en horario
  extendido - Entre las 6:00 am y las 10:00 pm
...
Sus actividades se desarrollan en horario
  nocturno - Después de 10:00 pm y antes de 6:00 am
...
El área construida de la edificación destinada
  al uso industrial es igual o menor a 100 m2.
...
El área construida de la edificación destinada
  al uso industrial es superior a 100 m2.
...
Parágrafo 1. Las industrias productoras y comercializadoras de plaguicidas,
...
ambiental para su operación, de acuerdo con la norma nacional.

Parágrafo 2. Las industrias cuyas actividades puedan significar
