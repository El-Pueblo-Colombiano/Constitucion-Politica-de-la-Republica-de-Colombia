---
title: "Artículo 85"
description: "Artículo 85 Plan de Ordenamiento Territorial de Bogotá POT"
---
...
1. El área de protección del entorno patrimonial. El área de
...
Integradora de Patrimonios”.

2. Las visuales representativas para la apreciación de los componentes de
...
formulación de las UPL.

Los predios que se encuentren en el área de protección del entorno
...
urbanístico en que se encuentren localizados, con las siguientes restricciones:

1.  Las estaciones radioeléctricas y de antenas de telecomunicación que en
...
punto de observación de las visuales representativas.

2. Salvo que se trate de elementos de alumbrado público o cámaras de
...
3. La soterranización de las redes existentes y el desmonte de todos los
...
harán durante la vigencia del POT.

4. La instalación de publicidad visual exterior visible desde cualquier
...
5. Dentro del área de protección del entorno patrimonial, toda modificación
...
6. No podrán instalarse contenedores de residuos sólidos dentro del área de
protección del entorno patrimonial.
